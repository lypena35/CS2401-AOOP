package Pena_Lorianne_Assignment4;
...
public class LunarRoverVehicle {
    ...
    public static void atRest() {
        System.out.println ("You are currently in the at rest / idle state");
    }
    ...
    public static void moveForward() {
        System.out.println ("You are accelerating forward.");
    }
    ...
    public static void goBackwards() {
        System.out.println ("You are accelerating backwards");
    }
     ...
     */
    public static void stabilizeSpeed() {
        System.out.println ("You are now moving forward at a stable speed");
    }
     ...
     */
    public static void decelerateBreak() {
        System.out.println ("You are now decelerating to a stop");
    }
    ...
    public static void idleState() {
        System.out.println ("You are currently in idle or rest state");
    }
     ...
     */
    public static void colorCam() {
        System.out.println ("The color camera is activated. Which camera will you like to use?");
    }
    ...
    public static void takePic() {
        System.out.println ("You have taken a picture! ");
    }
     ...
     */
    public static void activateTemp() {
        System.out.println ("The temporizer is activated. You have taken a 'moon selfie' ");
    }
     ...
     */
    public static void sixteenMMCam() {
        System.out.println ("The 16-mm Camera is activated. Which camera will you like to use? ");
    }
     ...
     */
    public static void activateDrill() {
        System.out.println ("The Drill state is activated.");
    }
    ...
    public static void turnOn() {
        System.out.println ("The Drill is now turned on.");
    }
    ...
    public static void turnOff() {
        System.out.println ("The Drill is now turned off.");
    }
